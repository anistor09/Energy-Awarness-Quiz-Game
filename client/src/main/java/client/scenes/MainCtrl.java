...
public class MainCtrl{
    ...
    private Player localPlayer; //this field is an intermediate field that serves for the InsertUsernameController to
    ...
    public void goTo(String screenName) {
        switch (screenName) {
            ...
            case "singleLobby":
                ...
                break;
            case "multiLobby":
                multiPlayerLobbyCtrl.setLocalPlayer(localPlayer);
